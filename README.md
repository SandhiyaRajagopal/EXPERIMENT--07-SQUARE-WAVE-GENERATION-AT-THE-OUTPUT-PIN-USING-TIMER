...
int main(void)
{
  ...
  HAL_TIM_PWM_Start(&htim2,TIM_CHANNEL_1);/* USER CODE BEGIN WHILE */
  while (1)
  {
    /* USER CODE END WHILE */
...
## Output screen shots of proteus  :
 ...
 ![Screenshot 2025-05-19 142432](https://github.com/user-attachments/assets/71a58c23-ddd8-4e9c-8c40-7248a761be54)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/user-attachments/assets/01cdce8e-bfe9-44d4-aa72-903d9829b436)
